                ...
                {expandirDonatario === index && (
                  <div className={styles.cardContent}>
                    ...
                    <div className={styles.section}>
                      ...
                      <p>
                        <strong>Endereço:</strong> {donatario.endereco}
                      </p>
                    </div>
            ...
            <Form>
                ...
                <Col md={6} className="mb-3">
                  <FloatingLabel controlId="floatingInput" label="Nome">
                    <Form.Control
                      ...
                      value={
                        !isEditMode
                          ? selectedDonatario.nome
                          : selectedDonatario.pessoa?.nome
                      }
                      onClick={() => {
                ...
                <Col md={6} className="mb-3">
                  <FloatingLabel controlId="floatingInput" label="CPF">
                    <Form.Control
                      ...
                      placeholder="CPF"
                      value={
                        selectedDonatario.CPF || selectedDonatario.pessoa?.cpf
                      }
                      onChange={(e) =>
                        setSelectedDonatario({
                          ...selectedDonatario,
              ...
              <Row>
                <Col md={6} className="mb-3">
                  <SexoSelect
                    onChange={(sexo) =>
                      setSelectedDonatario({ ...selectedDonatario, sexo })
                    }
                    value={
                      selectedDonatario.sexo || selectedDonatario.pessoa?.sexo
                    }
                    disabled={true}
                  />
                </Col>
                ...
                <Col md={6} className="mb-3">
                  <FloatingLabel label="Endereço">
                    <Form.Control
                      ...
                      value={
                        selectedDonatario.endereco ||
                        selectedDonatario.pessoa?.endereco
                      }
                      onChange={(e) =>
                        setSelectedDonatario({
                          ...selectedDonatario,
              ...
              <Row>
                <Col md={8} className="mb-3">
                  <FloatingLabel
                    controlId="floatingInput"
                    label="Há quanto tempo reside no local?"
                  >
                    <Form.Control
                      type="text"
                ...
                <Col md={8} className="mb-3">
                  <FloatingLabel controlId="floatingInput" label="Telefone">
                    <Form.Control
                      ...
                      value={
                        selectedDonatario.telefone ||
                        selectedDonatario.pessoa?.telefone
                      }
                      onChange={(e) =>
                        setSelectedDonatario({
                          ...selectedDonatario,
                  ...
                  <RadioGroup
                    ...
                    onChange={(e) =>
                      setSelectedDonatario({
                        ...
                        situacaoEnfermo:
                          e.target.value === "1"
                            ? selectedDonatario.situacaoEnfermo
                            : "",
                      })
                    }
                  />
                ...
                <Col md={14} className="mb-3">
                  ...
                  >
                    <Form.Control
                      ...
                      disabled={
                        selectedDonatario.enfermoNaCasa === "0" ||
                        !selectedDonatario.enfermoNaCasa
                          ? true
                          : false
                      }
                    />
                  ...
                  <strong>Idade:</strong> {dependente?.idade}
                  {
                    <GrauParentescoSelect
                      onChange={(grauParentesco) => {
                        ...
                        updatedDependentes[index].idGrauParentesco =
                          grauParentesco;
